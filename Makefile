...
all: ext2fs.kmod mount_ext2fs efsprobe ext2fs.util 
...
ext2_subr.o: src/gnu/ext2fs/ext2_subr.c
	$(CC) $(ARCH) -isysroot $(SYSROOT) -no-cpp-precomp -nostdinc $(CFLAGS) $(CFLAGS_KERN) $(DEFS) $(DEFS_KERN) $(KERN_INCS) $(INCS) $(WARNS) -c -o ext2_subr.o src/gnu/ext2fs/ext2_subr.c
...
ext2_vfsops.o: src/gnu/ext2fs/ext2_vfsops.c
	$(CC) $(ARCH) -isysroot $(SYSROOT) -no-cpp-precomp -nostdinc $(CFLAGS) $(CFLAGS_KERN) $(DEFS) $(DEFS_KERN) $(KERN_INCS) $(INCS) $(WARNS) -c -o ext2_vfsops.o src/gnu/ext2fs/ext2_vfsops.c

ext2_lookup.o: src/gnu/ext2fs/ext2_lookup.c
	$(CC) $(ARCH) -isysroot $(SYSROOT) -no-cpp-precomp -nostdinc $(CFLAGS) $(CFLAGS_KERN) $(DEFS) $(DEFS_KERN) $(KERN_INCS) $(INCS) $(WARNS) -c -o ext2_lookup.o src/gnu/ext2fs/ext2_lookup.c
...
ext2_vnops.o: src/gnu/ext2fs/ext2_vnops.c
	$(CC) $(ARCH) -isysroot $(SYSROOT) -no-cpp-precomp -nostdinc $(CFLAGS) $(CFLAGS_KERN) $(DEFS) $(DEFS_KERN) $(KERN_INCS) $(INCS) $(WARNS) -c -o ext2_vnops.o src/gnu/ext2fs/ext2_vnops.c
...
ext2fs.kmod: $(KEXT_OBJS)
	$(LD) $(ARCH) -isysroot $(SYSROOT) \
		-mmacosx-version-min=$(OSX_VERSION) \
		-lcpp_kext \
		-Xlinker -kext \
		-nostdlib -lkmodc++ \
		-lkmod -lcc_kext -o ext2fs.kmod $(KEXT_OBJS)
...
install: ext2fs.kmod
	sudo rm -rf $(EXTROOT)/ext2fs.kext
	sudo mkdir -p $(EXTROOT)/ext2fs.kext/Contents/MacOS 
	sudo cp ext2fs.kmod $(EXTROOT)/ext2fs.kext/Contents/MacOS/ext2fs
